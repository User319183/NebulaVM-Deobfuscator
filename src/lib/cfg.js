...
export class ControlFlowGraph {
  ...
  /**
   * Get all basic blocks in DFS traversal order starting from entry block.
   * Ensures unreachable blocks (dead code) are also included at the end.
   * Used for linearizing the CFG during code emission.
   */
  getBlocksInOrder() {
    const result = [];
    const visited = new Set();
